			...
			<div class="scrolling-table-container">
				...
				<table>
					...
					<tr>
						...
						<td>
							<div class="table-cell">
								<textarea class="standard-textarea" form="add-event-form" name="event_meetup" style="height: 50px;" maxlength="200"></textarea>
					...
					<tr>
						...
						<td>
							<div class="table-cell">
								<textarea class="standard-textarea" form="add-event-form" name="event_buff" style="height: 50px;" maxlength="200"></textarea>
